...
Use the defaults for an EC2 instance (direct access) and a t3.small instance type.  You may acrue charges with this level of processor.  If you want to stay in the free tier, select t3.micro.  If you want to understand charges, you can watch this [video](https://youtu.be/_CWKK0sypkE).
