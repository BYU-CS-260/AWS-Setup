...
5. Edit Inbound rules and add a rule for port 80 (HTTP) and 443 (HTTPS) and 3000 (You will use this with React) with Source 0.0.0.0/0 which specifies that the server should accept connections on these ports from anywhere.  Select the "Save rules" button and congratulate yourself for setting up the firewall.
